...
const FullPosts: React.FC = () => {
  ...
  return (
    <section className='bg-primary-light max-w-[1200px] mx-auto px-2 my-12'>
      <h2 className='text-xl font-bold mb-6'>Todos los Posts publicados</h2>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
        {displayedPosts.map((post) => (
          <div key={post.id} className='bg-white rounded-lg'>
            <img src={post.cover} alt={post.title} className='max-w-96 h-[240px] object-cover rounded-md mb-4' />
